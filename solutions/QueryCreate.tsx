...
function CreateUserForm() {
  ...
  // TODO: Exercise for the workshop 4
  ...
  // 3. Check the TanStack Query DevTools to see the mutation and its states.
  ...
  const mutation = useMutation({
    mutationFn: (userData: UserCreate) => {
      console.log('🟢 useMutation: Creating user...');
      return userAPI.create(userData);
    },
    onSuccess: (newUser) => {
      console. log('✅ useMutation: User created! ', newUser);
